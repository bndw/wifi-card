...
const resources = {
  ...
  'ru-RU': {
    translation: {
      ...
      'wifi.alert.password.length.5': 'Пароль должен состоять не менее чем из 5 символов',
      'wifi.alert.password.8': 'Пароль должен состоять не менее чем из 8 символов',
  ...
  'uk-UA': {
    translation: {
      ...
      'wifi.alert.password.length.5': 'Пароль повинен містити принаймні 5 символів',
