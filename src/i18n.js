...
const resources = {
  ...
  'id-ID': {
    translation: {
      ...
      'desc.privacy':
        'Informasi WiFi anda tidak akan dikirim ke server manapun. Tidak ada pelacakan, analitik, atau sidik jari yang digunakan di situs website ini.',
      ...
      'wifi.alert.name': 'Nama jaringan tidak bisa kosong',
