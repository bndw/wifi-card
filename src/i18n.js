...
const resources = {
  ...
  'tr-TR': {
    translation: {
      title: 'WiFi Kartı',
      'desc.use': 'WiFi giriş bilgilerinizle basit bir kart yazdırın. Buzdolabına bantlayın, cüzdanınızda saklayın vb.',
      'desc.privacy': 'WiFi bilgileriniz asla sunucuya gönderilmez. Bu web sitesinde hiçbir izleme, analiz veya parmak izi kullanılmamaktadır. Görüntüle',
      ...
      'wifi.tip': 'Otomatik olarak bağlanmak için telefonunuzun kamerası ile QR kodunu okutun',
