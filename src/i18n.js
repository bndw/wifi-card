...
const resources = {
  'en-US': {
    translation: {
      ...
      'wifi.size': 'Size',
      'wifi.size.small': 'Small',
      'wifi.size.medium': 'Medium',
      'wifi.size.large': 'Large',
  ...
  'nl-NL': {
    translation: {
      ...
      'wifi.login': 'WiFi Login',
      'wifi.size': 'Grootte',
      'wifi.size.small': 'Klein',
      'wifi.size.medium': 'Medium',
      'wifi.size.large': 'Groot',
  ...
  es: {
    translation: {
      ...
      'wifi.size': 'Suurus',
      'wifi.size.small': 'Väike',
      'wifi.size.medium': 'Keskmine',
      'wifi.size.large': 'Suur',
  ...
  pt: {
    translation: {
      ...
      'wifi.size': 'Tamanho',
      'wifi.size.small': 'Pequeno',
      'wifi.size.medium': 'Médio',
      'wifi.size.large': 'Grande',
  ...
  'uk-UA': {
    translation: {
      ...
      'wifi.size': 'Розмір',
      'wifi.size.small': 'Маленький',
      'wifi.size.medium': 'Середній',
      'wifi.size.large': 'Великий',
