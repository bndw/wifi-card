...
const resources = {
  ...
  'ca': {
    translation: {
      ...
      'wifi.alert.password.length.5': 'La contrasenya ha de tenir com a mínim 5 caràcters',
      'wifi.alert.password.8': 'La contrasenya ha de tenir com a mínim 8 caràcters',
      'button.rotate': 'Gira',
