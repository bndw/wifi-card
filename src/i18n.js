...
const resources = {
  ...
  ar: {
    translation: {
      ...
      'wifi.alert.password.length.5': 'يجب أن تكون كلمة المرور مكونة من ٥ أحرف على الأقل',
      'wifi.alert.password.length.8': 'يجب أن تكون كلمة المرور مكونة من ٨ أحرف على الأقل',
      'button.rotate': 'تدوير',
      'button.print': 'طباعة',
      select: 'اختر لغة',
    },
